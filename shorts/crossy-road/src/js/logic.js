...
const backLight = new DirectionalLight(0x000000, 0.4);
...
function Wheel() {
  const wheel = new Mesh(
    new BoxBufferGeometry(12 * zoom, 33 * zoom, 12 * zoom),
    new MeshLambertMaterial({ color: 0x333333, flatShading: true })
  );
...
function Car() {
  ...
  const main = new Mesh(
    new BoxBufferGeometry(60 * zoom, 30 * zoom, 15 * zoom),
  ...
  const cabin = new Mesh(
    new BoxBufferGeometry(33 * zoom, 24 * zoom, 12 * zoom),
    [
      ...
      new MeshPhongMaterial({ color: 0xcccccc, flatShading: true }), // top
      new MeshPhongMaterial({ color: 0xcccccc, flatShading: true }), // bottom
    ]
  );
...
function Truck() {
  ...
  const base = new Mesh(
    new BoxBufferGeometry(100 * zoom, 25 * zoom, 5 * zoom),
    new MeshLambertMaterial({ color: 0xb4c6fc, flatShading: true })
  );
  base.position.z = 10 * zoom;
  truck.add(base);

  const cargo = new Mesh(
    new BoxBufferGeometry(75 * zoom, 35 * zoom, 40 * zoom),
    new MeshPhongMaterial({ color: 0xb4c6fc, flatShading: true })
  );
  ...
  const cabin = new Mesh(
    new BoxBufferGeometry(25 * zoom, 30 * zoom, 30 * zoom),
    [
      new MeshPhongMaterial({ color, flatShading: true }), // back
      new MeshPhongMaterial({
        color,
        flatShading: true,
      ...
      new MeshPhongMaterial({ color, flatShading: true }), // top
      new MeshPhongMaterial({ color, flatShading: true }), // bottom
    ]
  );
...
function Three() {
  ...
  const trunk = new Mesh(
    new BoxBufferGeometry(15 * zoom, 15 * zoom, 20 * zoom),
    new MeshPhongMaterial({ color: 0x4d2926, flatShading: true })
  );
  ...
  const crown = new Mesh(
    new BoxBufferGeometry(30 * zoom, 30 * zoom, height * zoom),
    new MeshLambertMaterial({ color: 0x7aa21d, flatShading: true })
  );
...
function Chicken() {
  ...
  const body = new Mesh(
    new BoxBufferGeometry(chickenSize * zoom, chickenSize * zoom, 20 * zoom),
  ...
  const rowel = new Mesh(
    new BoxBufferGeometry(2 * zoom, 4 * zoom, 2 * zoom),
    new MeshLambertMaterial({ color: 0xf0619a, flatShading: true })
  );
...
function Road() {
  ...
  const createSection = (color) =>
    new Mesh(
      new PlaneBufferGeometry(boardWidth * zoom, positionWidth * zoom),
...
function Grass() {
  ...
  const createSection = (color) =>
    new Mesh(
      new BoxBufferGeometry(boardWidth * zoom, positionWidth * zoom, 3 * zoom),
      new MeshPhongMaterial({ color })
    );
