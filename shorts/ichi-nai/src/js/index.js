...
// import { reduceTitleAndMoveItUp, showupLevel } from "./animation";
...
import { App } from "./game-interface";
...
//       new MeshBasicMaterial({ color: 0x101010 })
//     );
//     this.scene.add(cube);
//   };
...
function main() {
  ...
  const onResize = () => {
    ...
    canvasEl.height = height;
    if (!isNil(app.basics)) {
      app.basics.onResize({ width, height });
    }
  };

  const addEventListenersToWindow = () => {
